...
/**
 * Draw an SVG path `d` string on a Canvas 2D context.
 * Supports M, L, Q, Z commands — covers Natural Earth country outlines and quadratic bezier routes.
 * Caller is responsible for ctx.save/restore, translate, scale, stroke/fill style.
 */
