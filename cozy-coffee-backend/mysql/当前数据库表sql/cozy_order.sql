...
CREATE TABLE `coffee_products`  (
  ...
  INDEX `idx_products_new`(`is_new_product`) USING BTREE,
  INDEX `idx_sku_config`(`size_type`, `sugar_type`, `temp_type`) USING BTREE
...
-- ----------------------------
INSERT INTO `coffee_products` VALUES (18, '额外浓缩', '增加一份浓缩咖啡液', 5.00, NULL, NULL, '/uploads/images/2026/01/e30c30878b9945a4b831b87697c03b8a.png', 'addon', 'inactive', 0, '2026-01-04 14:29:35', '2026-01-11 20:04:27', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (19, 'Cozy 美式', '选用埃塞俄比亚拼配豆，中深烘焙，干净明亮。', 22.00, 22.00, 25.00, '/uploads/images/2026/01/189826a79e9d4c49ac6178b7ce99e531.png', 'espresso', 'active', 0, '2026-01-04 14:54:34', '2026-01-16 09:25:16', 0, 'MEDIUM_LARGE', 'FREE_CHOICE', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (20, '经典拿铁', '采用 4.0 蛋白质含量鲜牛乳，奶香与咖香完美融合。', 28.00, 28.00, 32.00, '/uploads/images/2026/01/ac739771197a4152a6ca7271a65d89fa.png', 'espresso', 'active', 0, '2026-01-04 15:44:45', '2026-01-05 00:17:42', 0, 'MEDIUM_LARGE', 'FREE_CHOICE', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (21, '澳白', '更加浓郁的咖啡体，极致丝滑。', 30.00, 30.00, NULL, '/uploads/images/2026/01/cfab0831aef841e5a46df9b5f8219c8c.png', 'espresso', 'active', 0, '2026-01-04 16:05:18', '2026-01-11 20:04:27', 0, 'DEFAULT', 'FREE_CHOICE', 'HOT_ONLY');
INSERT INTO `coffee_products` VALUES (22, '生椰拿铁', '店内 Top 1 爆款，天然植物乳。', 32.00, 32.00, 35.00, '/uploads/images/2026/01/c047e8c6f9bb4a14b61100e83db0e4d9.png', 'espresso', 'active', 0, '2026-01-04 16:05:48', '2026-01-11 20:04:27', 0, 'MEDIUM_LARGE', 'FREE_CHOICE', 'NO_HOT');
INSERT INTO `coffee_products` VALUES (23, '燕麦拿铁', 'OATLY 燕麦奶，素食及乳糖不耐受友好。', 32.00, 32.00, 35.00, '/uploads/images/2026/01/b1907017561d49a58604d25db5825252.png', 'espresso', 'active', 0, '2026-01-04 16:06:33', '2026-01-04 16:57:38', 0, 'MEDIUM_LARGE', 'FREE_CHOICE', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (24, '拿铁金·桂花特调', '品牌色定制款，含干桂花与特制糖浆。', 38.00, 38.00, NULL, '/uploads/images/2026/01/3f99eb8fab1d4178b029b9f04786be2c.png', 'signature', 'active', 0, '2026-01-04 16:12:11', '2026-01-11 20:04:27', 1, 'DEFAULT', 'MIN_LESS_SWEET', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (25, '冰摇荔枝咖啡', '清爽果香，夏日消暑首选。', 36.00, 36.00, NULL, '/uploads/images/2026/01/59dff47a94e048b1a4a48e2e38dbed5b.png', 'signature', 'active', 0, '2026-01-04 16:12:41', '2026-01-11 20:04:27', 1, 'DEFAULT', 'MIN_LESS_SWEET', 'COLD_ONLY');
INSERT INTO `coffee_products` VALUES (26, '手冲精品咖啡 (SOE)', '瑰夏/花魁等名豆，限黑金会员 8.5 折。', 50.00, 50.00, NULL, '/uploads/images/2026/01/fc1d33c303304a248ba0dfeefa354a83.png', 'soe', 'active', 0, '2026-01-04 16:13:17', '2026-01-12 23:36:50', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (27, '海盐焦糖牛角包', '适合搭配美式，中和甜度。', 18.00, 18.00, NULL, '/uploads/images/2026/01/c0d7bc1d910d4e78826dcfa2b688d8b2.png', 'bakery', 'active', 0, '2026-01-04 16:14:16', '2026-01-11 20:04:27', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (28, '巴斯克芝士蛋糕', '浓郁奶香，下午茶点单王。', 35.00, 35.00, NULL, '/uploads/images/2026/01/6a3019fc9906461586d041d085311f38.png', 'bakery', 'active', 0, '2026-01-04 16:14:43', '2026-01-11 20:54:16', 0, 'DEFAULT', 'MIN_LESS_SWEET', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (29, '提拉米苏 (Cozy版)', '融入店内浓缩咖啡液，入口即化。', 38.00, 38.00, NULL, '/uploads/images/2026/01/b02a8fbb94854151bd22a1e7e8ee07cc.png', 'bakery', 'active', 0, '2026-01-04 16:15:11', '2026-01-11 20:04:27', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (30, '手工燕麦曲奇', '低成本加购项，适合凑单。', 12.00, 12.00, NULL, '/uploads/images/2026/01/8d8e49bb2fe644f3a516de7c25a0c9da.png', 'bakery', 'active', 0, '2026-01-04 16:17:53', '2026-01-11 20:04:27', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (31, '卡布奇诺', '绵密厚奶泡（Foam），口感蓬松，撒有少许可可粉。', 28.00, 28.00, 32.00, '/uploads/images/2026/01/ef038950cfe64cb897570169d70bdb47.png', 'espresso', 'active', 0, '2026-01-05 00:15:14', '2026-01-05 00:15:14', 0, 'MEDIUM_LARGE', 'FREE_CHOICE', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (32, '焦糖玛奇朵', '香草糖浆打底，覆盖绵密奶泡，淋上如网状般的焦糖酱。', 33.00, 33.00, 37.00, '/uploads/images/2026/01/b1cc65a69b5b4746b4222958e56efbff.png', 'espresso', 'active', 0, '2026-01-05 00:15:40', '2026-01-11 20:04:27', 0, 'MEDIUM_LARGE', 'MIN_LESS_SWEET', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (33, '摩卡', '融合比利时黑巧克力酱与鲜奶，顶层覆盖鲜奶油。', 32.00, 32.00, 36.00, '/uploads/images/2026/01/fdd4bbf3fa7a417fb52ac0608c016338.png', 'espresso', 'active', 0, '2026-01-05 00:16:05', '2026-01-11 20:04:27', 0, 'MEDIUM_LARGE', 'MIN_LESS_SWEET', 'ALL_OK');
INSERT INTO `coffee_products` VALUES (34, 'Dirty (脏咖)', '冰博克厚乳 x 热浓缩，大口饮用体验冷热交融。', 32.00, 32.00, NULL, '/uploads/images/2026/01/19582fe43fdf4f9da4972ec37f3224d0.png', 'espresso', 'active', 0, '2026-01-05 00:17:03', '2026-01-11 20:04:27', 0, 'DEFAULT', 'NO_SUGAR_ONLY', 'COLD_ONLY');
...
CREATE TABLE `pickup_code_counter`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `store_id` bigint(0) NOT NULL DEFAULT 1,
  `business_date` date NOT NULL,
  `last_seq` int(0) NOT NULL DEFAULT 0,
  `created_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `updated_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_store_business`(`store_id`, `business_date`) USING BTREE
...
CREATE TABLE `shop_order_items`  (
  ...
  `addons_amount` decimal(10, 2) NULL COMMENT '加料总金额',
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_id`(`order_id`) USING BTREE,
  INDEX `idx_product_id`(`product_id`) USING BTREE,
  CONSTRAINT `fk_shop_order_items_order_id` FOREIGN KEY (`order_id`) REFERENCES `shop_orders` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 373 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单项表（一单多商品）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `shop_orders`  (
  ...
  `pickup_code_generated_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `total_quantity` int(0) NOT NULL DEFAULT 0 COMMENT '商品总数量',
  `discount_amount` decimal(10, 2) NOT NULL COMMENT '优惠金额',
  `pay_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '实付金额（total_amount-discount_amount）',
  `applied_coupon_id` bigint(0) NULL DEFAULT NULL COMMENT '使用的券实例ID(cozy_mall.user_coupons.id)',
  `exp_earned` int(0) NOT NULL DEFAULT 0 COMMENT '获得EXP',
  ...
  INDEX `idx_orders_dining_method`(`dining_method`) USING BTREE,
  INDEX `idx_delivery_fee_waived`(`delivery_fee_waived`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 301 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '咖啡消费订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `shop_orders` VALUES (189, 'CF202601121823556171', 57, 18.00, 21, 'pending', '', '2026-01-12 18:23:56', 1, '2026-01-12', '053', '2026-01-12 18:23:56', '2026-01-12 18:23:56', 1, 2.16, 15.84, 105, 16, 0, 1.3, 'DINE_IN', NULL, 0.00, 0, NULL);
INSERT INTO `shop_orders` VALUES (190, 'CF202601121824497387', 57, 34.00, 16, 'pending', '', '2026-01-12 18:24:49', 1, '2026-01-12', '054', '2026-01-12 18:24:49', '2026-01-12 18:24:49', 2, 22.00, 12.00, 109, 12, 0, 1.3, 'DINE_IN', NULL, 0.00, 0, NULL);
...
INSERT INTO `shop_orders` VALUES (229, 'CF202601141913063014', 68, 30.00, 51, 'pending', '', '2026-01-14 19:13:07', 1, '2026-01-14', '001', '2026-01-14 19:13:07', '2026-01-14 19:13:07', 1, 0.00, 30.00, NULL, 30, 0, 1.7, 'DINE_IN', NULL, 0.00, 0, NULL);
...
INSERT INTO `shop_orders` VALUES (235, 'CF202601151940392291', 69, 38.00, 28, 'pending', '', '2026-01-15 19:40:39', 1, '2026-01-15', '006', '2026-01-15 19:40:39', '2026-01-15 19:40:39', 1, 10.00, 28.00, 255, 28, 0, 1.0, 'DINE_IN', NULL, 0.00, 0, NULL);
...
INSERT INTO `shop_orders` VALUES (241, 'CF202601152037032924', 71, 75.00, 53, 'pending', '', '2026-01-15 20:37:03', 1, '2026-01-15', '012', '2026-01-15 20:37:03', '2026-01-15 20:37:03', 2, 31.00, 44.00, 265, 44, 0, 1.2, 'DINE_IN', NULL, 0.00, 0, NULL);
...
INSERT INTO `shop_orders` VALUES (295, 'CF202601160921105665', 79, 40.00, 33, 'pending', '', '2026-01-16 09:21:11', 1, '2026-01-16', '005', '2026-01-16 09:21:11', '2026-01-16 09:21:11', 1, 20.50, 19.50, 308, 20, 0, 1.7, 'DELIVERY', '[313,312]', 3.00, 1, 'COUPON');
