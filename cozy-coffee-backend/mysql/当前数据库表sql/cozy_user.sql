...
CREATE TABLE `users`  (
  ...
  `token_version` int(0) NOT NULL DEFAULT 0 COMMENT 'Token版本号，用于禁用时使Token失效',
  `birthday` date NULL DEFAULT NULL COMMENT '用户生日(完整日期,年份可固定为2000或实际年份)',
  `birthday_set_at` datetime(0) NULL DEFAULT NULL COMMENT '生日设置时间',
  `next_birthday_reset_at` datetime(0) NULL DEFAULT NULL COMMENT '下次可修改生日时间(365天后)',
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (19, '94337998', '3187979459@qq.com', '$2a$10$TsAGe74bqJ6P7/FGs9d.Ceg2gocH85RKcwa/fCFjOffq.LbpoOPrm', '苏瑞鑫', '/images/default-avatar.png', NULL, 22, '2025-12-21 23:51:05', 0, NULL, '3187979459@qq.com', '2025-12-21 16:57:15', '2025-12-31 14:45:09', 'user', 'active', 0, NULL, NULL, NULL);
