...
CREATE TABLE `member_info`  (
  ...
  `exp_total` int(0) NOT NULL DEFAULT 0 COMMENT 'EXP总值（仅升级用）',
  `monthly_spent` decimal(10, 2) NULL COMMENT '褰撴湀娑堣垂閲戦?锛堜粎榛戝崱鐢ㄦ埛锛',
  `monthly_spent_month` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '娑堣垂缁熻?鏈堜唤(鏍煎紡: 2025-12)',
  ...
  `annual_exp` int(0) NULL DEFAULT 0,
  `last_settlement_year` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE,
  INDEX `idx_member_level`(`member_level`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of member_info
-- ----------------------------
INSERT INTO `member_info` VALUES (41, 41, 'gold', 6418, 3755, 2, '2026-01-05', '2025-12-31 16:01:08', '2026-01-05 01:43:08', 2000, 926.00, '2026-01', 150.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (42, 43, 'diamond', 12661, 3707, 8, '2026-01-10', '2026-01-02 11:23:03', '2026-01-11 14:19:22', 6031, 1039.00, '2026-01', 0.00, 'ACTIVE', 0, NULL);
...
INSERT INTO `member_info` VALUES (45, 46, 'diamond', 709, 709, 0, NULL, '2026-01-10 18:33:23', '2026-01-12 21:51:50', 4131, 132.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (46, 47, 'gold', 1072, 1072, 0, NULL, '2026-01-10 19:07:24', '2026-01-11 17:00:50', 1823, 323.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (47, 48, 'basic', 332, 332, 1, '2026-01-11', '2026-01-10 19:19:25', '2026-01-11 15:52:26', 50, 50.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (48, 49, 'silver', 561, 561, 1, '2026-01-11', '2026-01-10 19:24:05', '2026-01-11 14:32:23', 671, 171.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (49, 50, 'basic', 797, 797, 0, NULL, '2026-01-10 22:18:40', '2026-01-10 22:31:34', 127, 127.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (50, 51, 'basic', 200, 200, 0, NULL, '2026-01-11 18:07:11', NULL, 0, 0.00, NULL, 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (51, 52, 'basic', 372, 372, 0, NULL, '2026-01-12 10:45:01', '2026-01-12 11:31:27', 52, 52.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (52, 53, 'basic', 223, 223, 0, NULL, '2026-01-12 14:10:44', '2026-01-15 19:38:25', 23, 23.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (53, 54, 'silver', 222, 222, 0, NULL, '2026-01-12 14:47:44', '2026-01-12 15:36:17', 521, 22.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (54, 55, 'silver', 255, 255, 0, NULL, '2026-01-12 14:59:06', '2026-01-12 15:31:42', 520, 55.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (55, 38, 'basic', 0, 0, 0, NULL, '2026-01-12 15:36:47', NULL, 0, 0.00, NULL, 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (56, 56, 'diamond', 461, 461, 0, NULL, '2026-01-12 15:42:20', '2026-01-12 21:38:57', 4048, 99.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (57, 57, 'diamond', 379, 379, 0, NULL, '2026-01-12 17:18:20', '2026-01-12 17:44:53', 4065, 66.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
...
INSERT INTO `member_info` VALUES (59, 59, 'black', 259, 259, 0, NULL, '2026-01-12 20:12:34', '2026-01-12 21:04:19', 9036, 46.00, '2026-01', 264.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (60, 60, 'diamond', 326, 326, 0, NULL, '2026-01-12 21:44:00', '2026-01-12 21:47:14', 4021, 22.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (61, 61, 'diamond', 313, 313, 0, NULL, '2026-01-12 22:05:01', '2026-01-12 22:05:46', 4010, 11.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (62, 62, 'black', 387, 387, 1, '2026-01-12', '2026-01-12 22:31:25', '2026-01-13 13:53:16', 9021, 66.00, '2026-01', 279.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (63, 63, 'black', 229, 229, 0, NULL, '2026-01-13 14:08:25', '2026-01-13 14:10:40', 9021, 22.00, '2026-01', 279.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (64, 64, 'black', 1145, 1145, 0, NULL, '2026-01-13 15:24:51', '2026-01-13 15:25:33', 9043, 44.00, '2026-01', 257.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (65, 65, 'diamond', 317, 317, 0, NULL, '2026-01-13 16:42:37', '2026-01-13 16:43:01', 4013, 14.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (66, 66, 'black', 1106, 1106, 0, NULL, '2026-01-13 17:25:19', '2026-01-13 17:25:41', 9013, 14.00, '2026-01', 287.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (67, 67, 'black', 2807, 2807, 1, '2026-01-13', '2026-01-13 18:15:50', '2026-01-13 18:16:54', 9021, 22.00, '2026-01', 279.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (68, 68, 'black', 2877, 275, 2, '2026-01-15', '2026-01-13 18:31:38', '2026-01-13 18:33:20', 9020, 30.00, '2026-01', 280.00, 'ACTIVE', 0, NULL);
...
INSERT INTO `member_info` VALUES (70, 70, 'silver', 496, 496, 0, NULL, '2026-01-15 19:44:35', '2026-01-15 19:51:43', 687, 188.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (71, 71, 'gold', 316, 316, 0, NULL, '2026-01-15 20:05:08', '2026-01-15 20:05:44', 1559, 60.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (72, 72, 'diamond', 326, 326, 0, NULL, '2026-01-15 20:37:43', '2026-01-15 20:50:24', 4021, 22.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (73, 73, 'black', 2040, 2040, 1, '2026-01-15', '2026-01-15 21:11:02', '2026-01-15 22:43:43', 9021, 33.00, '2026-01', 279.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (74, 74, 'black', 548, 548, 0, NULL, '2026-01-15 22:46:17', '2026-01-15 22:47:27', 9128, 128.00, '2026-01', 172.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (75, 75, 'black', 1403, 1403, 0, NULL, '2026-01-15 23:11:21', '2026-01-15 23:11:43', 10133, 133.00, '2026-01', 167.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (76, 76, 'basic', 424, 424, 0, NULL, '2026-01-15 23:21:22', '2026-01-15 23:21:59', 144, 144.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
...
INSERT INTO `member_info` VALUES (78, 78, 'gold', 268, 268, 0, NULL, '2026-01-16 08:24:53', '2026-01-16 08:58:02', 1510, 11.00, '2026-01', 300.00, 'ACTIVE', 0, NULL);
INSERT INTO `member_info` VALUES (79, 79, 'black', 3025, 2845, 7, '2026-01-16', '2026-01-16 08:25:21', '2026-01-16 08:50:55', 9079, 80.00, '2026-01', 221.00, 'ACTIVE', 0, NULL);
...
CREATE TABLE `monthly_task_orders`  (
  ...
  INDEX `idx_user_month`(`user_id`, `task_month`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 115 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '月度任务订单去重表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `monthly_tasks`  (
  ...
  `updated_at` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_month`(`user_id`, `task_month`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE,
  INDEX `idx_task_month`(`task_month`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '月度任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_expiry_notifications`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `lot_id` bigint(0) NOT NULL COMMENT '积分批次ID',
  `remind_days` int(0) NOT NULL COMMENT '提前提醒天数: 30/7/1',
  `sent_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_lot_remind`(`lot_id`, `remind_days`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE
...
CREATE TABLE `points_lot_consumptions`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `lot_id` bigint(0) NOT NULL COMMENT '批次ID',
  `consume_amount` int(0) NOT NULL COMMENT '消耗积分',
  `consume_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消耗类型：redeem',
  `consume_id` bigint(0) NULL DEFAULT NULL COMMENT '关联ID（兑换订单ID）',
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE,
  INDEX `idx_lot_id`(`lot_id`) USING BTREE,
  INDEX `idx_consume`(`consume_type`, `consume_id`) USING BTREE,
  CONSTRAINT `fk_points_lot_consumptions_lot_id` FOREIGN KEY (`lot_id`) REFERENCES `points_lots` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 134 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '积分扣减明细表（FIFO扣减凭证）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_lots`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `initial_amount` int(0) NOT NULL COMMENT '初始积分',
  `remaining` int(0) NOT NULL COMMENT '剩余积分',
  ...
  `source_id` bigint(0) NULL DEFAULT NULL COMMENT '关联ID（订单ID/签到ID等）',
  `expires_at` datetime(0) NOT NULL COMMENT '到期时间',
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_expires`(`user_id`, `expires_at`, `id`) USING BTREE,
  INDEX `idx_expires`(`expires_at`) USING BTREE,
  INDEX `idx_source`(`source_type`, `source_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 288 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '积分批次表（FIFO）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_transactions`  (
  ...
  `source_id` bigint(0) NULL DEFAULT NULL COMMENT '关联ID(用于幂等,如userId/orderId等)',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '描述',
  `created_at` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '交易时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_reward`(`user_id`, `source_type`, `source_id`) USING BTREE,
  INDEX `idx_user_id`(`user_id`) USING BTREE,
  INDEX `idx_source_type`(`source_type`) USING BTREE,
  INDEX `idx_created_at`(`created_at`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 531 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '积分流水表' ROW_FORMAT = Dynamic;
